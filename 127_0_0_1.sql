...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 16 jan 2018 kl 12:46
...
--
-- Databas: `anslagstavla`
--
CREATE DATABASE IF NOT EXISTS `anslagstavla` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `anslagstavla`;
...
CREATE TABLE `anslagstavla` (
  ...
  `setup` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `date_added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `textcontent` text COLLATE utf8mb4_bin NOT NULL,
  `title` varchar(100) COLLATE utf8mb4_bin NOT NULL,
  `stub` text COLLATE utf8mb4_bin NOT NULL,
  `responsible` varchar(200) COLLATE utf8mb4_bin NOT NULL,
  `organ` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `storage` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `document` varchar(255) COLLATE utf8mb4_bin NOT NULL
...
('root', '[{\"db\":\"anslagstavla\",\"table\":\"anslagstavla\"}]');
...
('root', '2017-11-28 13:30:21', '{\"lang\":\"sv\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
